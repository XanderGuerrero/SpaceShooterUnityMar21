...
public class AsteroidCollisionDestroy : MonoBehaviour
{
    [SerializeField]
    ...
    public void OnCollisionEnter(Collision collision)
    {
        ...
        if (ni == null || ni.GetID() != this.whoActivatedMe.GetActivator())
        {
            ...
            networkIdentity.GetSocket().Emit("asteroidCollisionDestroy", new JSONObject(JsonUtility.ToJson(new IdData()
            {
